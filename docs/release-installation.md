...
For this established project the final command must return `2.5.1` or newer; a 404
...
project hiện tại lệnh cuối phải trả `2.5.1` hoặc mới hơn, còn 404 là blocker. Chỉ
